...
--
-- Host: 127.0.0.1
-- Tempo de geração: 13/11/2024 às 01:13
...
INSERT INTO `administracoes` (`id`, `receita_id`, `enfermeiro_id`, `data_registro`, `hora_registro`) VALUES
(1, 1, 1, '2024-11-21', '21:11:00');
...
(4, 2, 1, 'mercurio', '2024-11-13', '23:23:00', '1L');
...
ALTER TABLE `administracoes`
  ...
  ADD KEY `enfermeiro_id` (`enfermeiro_id`);
...
ALTER TABLE `administracoes`
  ...
  ADD CONSTRAINT `administracoes_ibfk_2` FOREIGN KEY (`enfermeiro_id`) REFERENCES `enfermeiros` (`id`);
