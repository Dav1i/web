        ...
        <form method="POST" action="recepcao.php">
            ...
            <div id="campos_medico" style="display: none;">
                <div class="form-group">
                    ...
                    <input type="text" id="crm_ou_coren" name="crm_ou_coren">
                </div>
                <div class="form-group">
...
<script>
    ...
    function exibirCampos() {
        ...
        var crmOuCorenField = document.getElementById('crm_ou_coren');
        var especialidadeField = document.getElementById('especialidade');

        if (tipo == 'medico') {
            document.getElementById('campos_medico').style.display = 'block';
            document.getElementById('campos_enfermeiro').style.display = 'none';

            crmOuCorenField.setAttribute('required', 'required'); // CRM é obrigatório para médicos
            especialidadeField.setAttribute('required', 'required');
        } else {
            document.getElementById('campos_enfermeiro').style.display = 'block';
            document.getElementById('campos_medico').style.display = 'none';

            crmOuCorenField.setAttribute('required', 'required'); // COREN é obrigatório para enfermeiros
            especialidadeField.removeAttribute('required'); // Especialidade não é necessária para enfermeiros
        }
    }
