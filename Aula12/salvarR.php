...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($paciente_id) || empty($nome_medicamento) || empty($data_administracao) || empty($hora_administracao) || empty($dose)) {
        ...
        try {
            ...
            $sql = "INSERT INTO receitas (paciente_id, medico_id, nome_medicamento, data_administracao, hora_administracao, dose) 
                    VALUES (:paciente_id, :medico_id, :nome_medicamento, :data_administracao, :hora_administracao, :dose)";
